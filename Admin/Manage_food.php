...
<?php include 'sidebar.php'; ?>
    ...
    <div class="container">
        ...
        <button class="btn-add" onclick="addfood()">+ Add New Food Items</button>
...
function addfood() {
    Swal.fire({
        ...
        html: `
            ...
            <input id="name" class="swal2-input" placeholder="Food Name">
            <input id="category_id" class="swal2-input" placeholder="Category ID">
            <input id="quantity" class="swal2-input" placeholder="Stock">
        ...
        preConfirm: () => {
            ...
            return $.post("add-food.php", data, function(response) {
